...
class FileSystem {
    public: 
        ...
        virtual bool write_file(const boost::filesystem::path& filePath, const std::string& body) = 0;
        virtual int gen_id_and_write_file(const boost::filesystem::path& dirPath, const std::string& body) = 0;
